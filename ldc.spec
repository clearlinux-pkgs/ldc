...
%prep
%setup -q -n ldc-1.24.0-src
cd %{_builddir}/ldc-1.24.0-src
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605633153
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ldc-1.24.0-src/runtime/phobos/LICENSE_1_0.txt %{buildroot}/usr/share/package-licenses/ldc/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libdruntime-ldc-debug-shared.so.2.0.94
/usr/lib64/libdruntime-ldc-debug-shared.so.94
/usr/lib64/libdruntime-ldc-shared.so.2.0.94
/usr/lib64/libdruntime-ldc-shared.so.94
/usr/lib64/libphobos2-ldc-debug-shared.so.2.0.94
/usr/lib64/libphobos2-ldc-debug-shared.so.94
/usr/lib64/libphobos2-ldc-shared.so.2.0.94
/usr/lib64/libphobos2-ldc-shared.so.94
