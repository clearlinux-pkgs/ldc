...
Source0  : https://github.com/ldc-developers/ldc/releases/download/v1.20.1/ldc-1.20.1-src.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : Artistic-2.0 BSD-3-Clause BSL-1.0 GPL-2.0 MIT
...
%prep
%setup -q -n ldc-1.20.1-src
cd %{_builddir}/ldc-1.20.1-src
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587710908
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ldc-1.20.1-src/LICENSE %{buildroot}/usr/share/package-licenses/ldc/dbbd94db0810d7da66e15fe2ea25727887b424c2
cp %{_builddir}/ldc-1.20.1-src/runtime/druntime/LICENSE.txt %{buildroot}/usr/share/package-licenses/ldc/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
cp %{_builddir}/ldc-1.20.1-src/runtime/phobos/LICENSE_1_0.txt %{buildroot}/usr/share/package-licenses/ldc/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libdruntime-ldc-debug-shared.so.2.0.90
/usr/lib64/libdruntime-ldc-debug-shared.so.90
/usr/lib64/libdruntime-ldc-shared.so.2.0.90
/usr/lib64/libdruntime-ldc-shared.so.90
/usr/lib64/libphobos2-ldc-debug-shared.so.2.0.90
/usr/lib64/libphobos2-ldc-debug-shared.so.90
/usr/lib64/libphobos2-ldc-shared.so.2.0.90
/usr/lib64/libphobos2-ldc-shared.so.90

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/ldc/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
/usr/share/package-licenses/ldc/dbbd94db0810d7da66e15fe2ea25727887b424c2
